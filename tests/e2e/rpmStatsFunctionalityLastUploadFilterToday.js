...
module.exports = {
  ...
  'Clinic workspace rpm stats export | lastUploadFilterToday | patientFilterSearch:autodex | rpmExportStartDateSelected:40 days from today ': async (browser) => {
    // setup config
  ...
  'Clinic workspace rpm stats export | lastUploadFilterToday | patientFilterSearch:autodex | rpmExportEndDateSelected:10 days from today  ': async (browser) => {
    // setup config
    const clinicPatientListPage = browser.page.clinicPatientListPage();
    const clinicPatientList = clinicPatientListPage.section.patientList;
  ...
  'Clinic workspace rpm stats export | lastUploadFilterToday | patientFilterSearch:autodex | rpmExportStartDateSelected:57 days from today | rpmExportEndDateSelected:start date + 15 days ': async (browser) => {
    // setup config
    const clinicPatientListPage = browser.page.clinicPatientListPage();
    const clinicPatientList = clinicPatientListPage.section.patientList;
  ...
  'Clinic workspace rpm stats export | lastUploadFilterToday | patientFilterSearch:autodex | rpmExportDefaultDate ': async (browser) => {
    // setup config
    const clinicPatientListPage = browser.page.clinicPatientListPage();
    const clinicPatientList = clinicPatientListPage.section.patientList;
    const today = moment();
