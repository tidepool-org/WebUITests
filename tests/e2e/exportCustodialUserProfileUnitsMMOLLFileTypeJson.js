...
module.exports = {
  ...
  'Click export units and file type'(browser) {
    ...
    userProfile.waitForElementVisible('@mmoll', browser.globals.elementTimeout);
    userProfile.click('@mmoll');
    userProfile.waitForElementVisible('@json', browser.globals.elementTimeout);
    userProfile.click('@json');
    userProfile.expect.element('@mmoll').to.be.selected;
    userProfile.expect.element('@json').to.be.selected;
  },
