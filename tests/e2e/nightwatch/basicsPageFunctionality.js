...
module.exports = {
  ...
  "BG readings dashboard functionality"(browser) {
    ...
    bgDashboard.waitForElementVisible(
      "@dayHover",
    ...
    bgDashboard.getText("@dayHover", (result) => {
      ...
      dailyViewDay.waitForElementVisible(
        "@chartsContainer",
        browser.globals.elementTimeout
      );
      dailyViewDay.waitForElementVisible(
  ...
  "Site Changes dashboard functionality"(browser) {
    const basics = browser.page.basicsPage();
    const daily = browser.page.dailyPage();
    const dailyViewDay = daily.section.dailyViewDay;
    const SiteDashboard = basics.section.SiteChanges;
    const common = browser.page.commonElementsPage();
    const patientData = common.section.patientData;
    SiteDashboard.waitForElementVisible(
      "@title",
      browser.globals.elementTimeout
    );
    //SiteDashboard.click("@settingsToggle");
    SiteDashboard.click("@fillCannulaOption");
    SiteDashboard.getLocationInView("@bottomOfDashboard");
    SiteDashboard.expect.element("@filledCannulaDay").to.be.visible;
    SiteDashboard.expect.element("@filledTubingDay").to.not.be.present;
    SiteDashboard.moveToElement("@filledCannulaDay", 0, 0);
    SiteDashboard.getText("@dayHover", (result) => {
      const day = result.value;
      SiteDashboard.click("@dayHover");
      dailyViewDay.waitForElementVisible(
        "@chartsContainer",
        browser.globals.elementTimeout
      );
    ...
    SiteDashboard.getLocationInView("@bottomOfDashboard");
    SiteDashboard.click("@fillTubingOption");
    SiteDashboard.expect.element("@filledTubingDay").to.be.visible;
    SiteDashboard.expect.element("@filledCannulaDay").to.not.be.present;
    SiteDashboard.moveToElement("@filledTubingDay", 0, 0);
    SiteDashboard.getText("@dayHover", (result) => {
      const day = result.value;
      SiteDashboard.click("@dayHover");
      dailyViewDay.waitForElementVisible(
