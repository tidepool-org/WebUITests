...
module.exports = {
  ...
  "Clinic workspace selection"(browser) {
    ...
    clinicWorkspace.waitForElementVisible(
      "@title",
  ...
  "Clinic workspace show all"(browser) {
    ...
    clinicPatientList.waitForElementVisible(
      "@showAll",
      browser.globals.elementTimeout,
    );
    clinicPatientList.click("@showAll");
    clinicPatientList.expect
      .element("@patientDetails")
      .text.to.contain("Patient Details");
    clinicPatientList.expect
      .element("@dataRecency")
      .text.to.contain("Data Recency");
    clinicPatientList.expect
      .element("@patientTags")
      .text.to.contain("Patient Tags");
