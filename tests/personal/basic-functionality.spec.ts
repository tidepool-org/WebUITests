...
test.describe('Patient Data Navigation and Visualization', () => {
  ...
  test(
    'should display daily chart when selecting a date from basics page',
    {
      tag: createValidatedTags([TEST_TAGS.PATIENT, TEST_TAGS.UI, TEST_TAGS.PRIORITY_HIGH]),
    },
    async ({ page }) => {
      const basicsPage = new PatientDataBasicsPage(page);
  ...
  test(
    'should display bolus dashboard when selecting a date from basics page',
    {
  ...
  test(
    'should display Infusion site changes dashboard when selecting a date from basics page',
    {
      tag: createValidatedTags([TEST_TAGS.PATIENT, TEST_TAGS.UI, TEST_TAGS.PRIORITY_MEDIUM]),
    },
    async ({ page }) => {
  ...
  test(
    'The hover over elements in sidebar shows correct values',
    {
      tag: createValidatedTags([TEST_TAGS.PATIENT, TEST_TAGS.UI, TEST_TAGS.PRIORITY_LOW]),
    },
    async ({ page }) => {
      // Stats for BGM
