...
module.exports = {
  ...
  "verify site changes dashboard elements present"(browser) {
    const basics = browser.page.basicsPage();
    ...
    SiteDashboard.moveToElement("@bottomOfDashboard", 0, 0);
    SiteDashboard.expect.element("@siteChangeDay").to.be.visible;
    SiteDashboard.assert.screenshotIdenticalToBaseline(
      "@siteChangesCalendar",
      "infusion site changes dashboard"
    );
  },
  ...
  "verify sidebar and BGM agg stat elements present"(browser) {
    ...
    SiteDashboard.moveToElement("@title", 0, 0);
