...
const ClinicianNavigation_1 = __importDefault(require("../../page-objects/clinician/ClinicianNavigation"));
const ClinicianDashboardPage_1 = __importDefault(require("../../page-objects/clinician/ClinicianDashboardPage"));
const AccountNavigation_1 = __importDefault(require("../../page-objects/account/AccountNavigation"));
/**
 * Initialize clinician navigation helpers after login
 */
async function setupClinicianSession(page) {
    // Wait for clinician navigation to be available
    const nav = new ClinicianNavigation_1.default(page);
 ...
 */
async function navigateToWorkspaceSelection(page) {
    const accountNav = new AccountNavigation_1.default(page);
 ...
 */
async function navigateToWorkspace(workspaceKey, page) {
    const clinicianNav = new ClinicianNavigation_1.default(page);
 ...
 */
async function navigateTo(targetPage, page, workspaceKey) {
    const clinicianNav = new ClinicianNavigation_1.default(page);
    ...
    const isInWorkspaceContext = page.url().includes('clinic-workspace') ||
 ...
 */
async function executeAcrossWorkspaces(workspaceConfigs, action, page) {
 ...
 */
async function findAndAccessPatientByPartialName(searchTerm, page) {
    const dashboard = new ClinicianDashboardPage_1.default(page);
 ...
 * @param page - The Playwright page object
 */
async function accessPatient(patientName, page) {
    const dashboard = new ClinicianDashboardPage_1.default(page);
