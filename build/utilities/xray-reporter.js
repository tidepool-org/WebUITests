...
class XRayReporter {
    ...
    async uploadTestResults(token, xmlContent) {
        try {
            ...
            const response = await fetch('https://xray.cloud.getxray.app/api/v2/import/execution/junit?projectKey=XT&testPlanKey=XT-380', {
                method: 'POST',
                headers: {
    ...
    async onEnd(result) {
        ...
        try {
            ...
            const testResults = node_fs_1.default.readFileSync('./test-results/test-results.xml', 'utf8');
