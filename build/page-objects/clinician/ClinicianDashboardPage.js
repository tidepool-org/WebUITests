...
class ClinicianDashboardPage {
    constructor(page) {
        this.url = '/clinic-workspace';
        this.name = 'ClinicianDashboardPage'; // Added name for step decorator context
        this.page = page;
        // Main page locators
     ...
     */
    async openAndFillAddPatientDialog(name, birthdate) {
...
exports.default = ClinicianDashboardPage;
