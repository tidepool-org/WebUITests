...
export default class ClinicAdminPage {
  ...
  url: string = "/clinic-admin";
  name: string = "ClinicAdminPage"; // Added name for step decorator context
  ...
  constructor(page: Page) {
    ...
    this.editClinicModalTitle = this.editClinicModal.getByRole("heading", { name: "Edit Workspace Details" });
