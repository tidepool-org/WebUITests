...
test.describe('Clinician Account Settings Access', () => {
    ...
    let api;
    test('should allow navigation to account settings and capture GET response', {
        ...
        await test.stepNoScreenshot('Then PUT request is validated and email is set to new value', async () => {
