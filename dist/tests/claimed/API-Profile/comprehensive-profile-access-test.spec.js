...
test.describe('Comprehensive Profile Access Test: Edit as Claimed, View as Shared and Clinician', () => {
    test('should edit claimed profile then verify view-only access for shared and clinician users', {
        ...
        await test.stepNoScreenshot('Then profile endpoint responds with PUT request consistent with schema', async () => {
