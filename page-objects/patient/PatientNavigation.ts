...
export default class PatientNav {
  ...
  constructor(page: Page) {
    ...
    this.pages = {
      ...
      'ChartDateRange': {
        name: 'ChartDateRange',
        link: page.locator('button svg, .css-15vjjnj svg, [aria-label*="calendar"], [title*="calendar"]').first(), // Calendar icon in blue navigation bar
        verifyURL: '',
